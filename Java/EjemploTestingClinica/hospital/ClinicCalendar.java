...
public class ClinicCalendar {
    ...
    public boolean hasAppointment(String patientFirstName, String patientLastName) {
        for(PatientAppointment pa : this.appointments) {
            if(pa.getPatientFirstName() == patientFirstName && pa.getPatientLastName() == patientLastName)
                return true;
        }
        return false;
    }
